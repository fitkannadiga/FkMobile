...
/***/ "./src/app/api/article-details.service.ts":
/*!************************************************!*\
  !*** ./src/app/api/article-details.service.ts ***!
  \************************************************/
/*! exports provided: ArticleDetailsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ArticleDetailsService", function() { return ArticleDetailsService; });
...
var ArticleDetailsService = /** @class */ (function () {
    function ArticleDetailsService() {
    }
    ArticleDetailsService.prototype.setArticleDetails = function (data, language) {
        this.articleData = data;
        this.articleLang = language;
    };
    ArticleDetailsService.prototype.getArticleData = function () {
        return { "data": this.articleData, "lang": this.articleLang };
    };
    ArticleDetailsService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [])
    ], ArticleDetailsService);
    return ArticleDetailsService;
}());
...
/***/ "./src/app/api/client-data.service.ts":
/*!********************************************!*\
  !*** ./src/app/api/client-data.service.ts ***!
  \********************************************/
...
var ClientDataService = /** @class */ (function () {
    ...
    ClientDataService.prototype.saveClientData = function (data) {
        this.dietPlan = data.diet;
        this.workoutPlan = data.workout;
    };
    ClientDataService.prototype.getClientDiet = function () {
        return this.dietPlan;
    };
    ClientDataService.prototype.getClientWorkout = function () {
...
/***/ "./src/app/api/muscle-group-service.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/api/muscle-group-service.service.ts ***!
  \*****************************************************/
/*! exports provided: MuscleGroupServiceService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MuscleGroupServiceService", function() { return MuscleGroupServiceService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var MuscleGroupServiceService = /** @class */ (function () {
    function MuscleGroupServiceService() {
    }
    MuscleGroupServiceService.prototype.setMuscleGroupData = function (data) {
        this.muscleGroupData = data;
    };
    MuscleGroupServiceService.prototype.getIndividualMuscleWorkout = function (muscle) {
        // return this.splitData;
        return this.muscleGroupData.filter(function (el) {
            return el.muscle == muscle;
        });
    };
    MuscleGroupServiceService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [])
    ], MuscleGroupServiceService);
    return MuscleGroupServiceService;
}());
...
/***/ "./src/app/api/nutrient-graph.service.ts":
/*!***********************************************!*\
  !*** ./src/app/api/nutrient-graph.service.ts ***!
  \***********************************************/
/*! exports provided: NutrientGraphService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NutrientGraphService", function() { return NutrientGraphService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var NutrientGraphService = /** @class */ (function () {
    ...
    NutrientGraphService = __decorate([
        ...
        __metadata("design:paramtypes", [])
    ], NutrientGraphService);
    return NutrientGraphService;
}());
...
/***/ "./src/app/api/split-data-service.service.ts":
/*!***************************************************!*\
  !*** ./src/app/api/split-data-service.service.ts ***!
  \***************************************************/
/*! exports provided: SplitDataServiceService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SplitDataServiceService", function() { return SplitDataServiceService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var SplitDataServiceService = /** @class */ (function () {
    function SplitDataServiceService() {
    }
    SplitDataServiceService.prototype.setWorkoutSplit = function (data) {
        this.splitData = data;
    };
    SplitDataServiceService.prototype.getSplitData = function () {
        return this.splitData;
    };
    SplitDataServiceService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [])
    ], SplitDataServiceService);
    return SplitDataServiceService;
}());
